    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <motion.div
          ...
          className="max-w-6xl mx-auto pt-12 pb-16"
        >
          <motion.h3 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Phone, text: "+387 61 123 456", gradient: "from-indigo-500 to-violet-600", delay: 0.1 },
              { icon: Mail, text: "info@autohausmiftari.com", gradient: "from-cyan-500 to-blue-600", delay: 0.2 },
              { icon: MapPin, text: "Sarajevo, Bosnien und Herzegowina", gradient: "from-green-500 to-teal-600", delay: 0.3 }
            ].map((item, index) => (
              <motion.div
                key={index}
                ...
                whileHover={{ rotate: 10, transition: { duration: 0.4 } }}
                className="group"
                style={{ transformStyle: 'preserve-3d', backfaceVisibility: 'hidden' }}
              >
                <div className="flex flex-col items-center text-center bg-gradient-to-br from-neutral-800 via-neutral-900 to-neutral-800 rounded-3xl p-10 border border-neutral-700 shadow-xl transition-all duration-300 min-h-[14rem] backdrop-blur-sm">
                  <motion.div 
                    className={`bg-gradient-to-br ${item.gradient} p-6 rounded-full shadow-lg mb-6`}
