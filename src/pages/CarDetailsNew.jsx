...
import { 
  ...
  Eye, ChevronLeft, ChevronRight, X, Heart, Share2, Car, Palette, Cog
} from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-black via-neutral-900 to-black flex items-center justify-center">
        ...
        >
          ...
          <p className="text-neutral-400 mb-6">{error || 'Das angeforderte Fahrzeug existiert nicht oder ist nicht verfügbar.'}</p>
          <button
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex justify-between items-center p-4 bg-neutral-800/50 rounded-xl">
                      ...
                      <span className="text-white font-medium">{car.cubicCapacity ? `${car.cubicCapacity} cm³` : 'N/A'}</span>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-neutral-800/50 rounded-xl">
