  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 py-8">
        {/* Header */}
        <div
          className={`mb-12 md:mb-20 text-center transform transition-all duration-1000 ${
        ...
        <div className="hidden md:block relative">
          <div className="relative flex items-center justify-between mb-8">
            ...
            {steps.map((step, idx) => (
              <div
                key={idx}
                className={`relative flex flex-col items-center flex-1 z-10 transform transition-all duration-700 delay-${
                  idx * 200
                } ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
              >
                {/* Step Number Badge */}
        ...
        {/* CTA Button */}
        <div
          className={`text-center mt-12 md:mt-16 transform transition-all duration-1000 delay-1000 ${
            isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
          }`}
        >
          <button
